...
function GetSelectedRenamerConfigNewFilenameColumn(withUnique){
	var newFilenameColumn = "";
	if(withUnique)
		newFilenameColumn = selectedRenamerConfig.filenameNewColumn + " (New)";
	else
		newFilenameColumn = selectedRenamerConfig.filenameNewColumn;

	return (newFilenameColumn);
}

function GetSelectedRenamerConfigOriginalFilenameColumn(withUnique){
	var originalFilenameColumn = "";
	if(withUnique)
	originalFilenameColumn = selectedRenamerConfig.originalFilenameColumn + " (Original)";
	else
	originalFilenameColumn = selectedRenamerConfig.originalFilenameColumn;

	return (originalFilenameColumn);
}
